                        ...
                        <div class="card card-flush h-xl-100">
                            ...
                            <div class="card-header pt-5 mb-6">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">ملخص الطلبات
                                        والمبيعات</span>
                                    <!--end::Description-->
                                </h3>
                            </div>
                                        ...
                                        <div class="table-responsive mx-9 mt-n6">
                                            ...
                                            <table class="table align-middle gs-0 gy-4">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <a href="#" class="text-gray-600 fw-bold fs-6">12:40
                                                                AM</a>
                                                        </td>
                                                        <td class="pe-0 text-end">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="#" class="text-gray-600 fw-bold fs-6">11:30
                                                                PM</a>
                                                        </td>
                                                        <td class="pe-0 text-end">
                                                            <span
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="#" class="text-gray-600 fw-bold fs-6">4:25
                                                                PM</a>
                                                        </td>
                                                        <td class="pe-0 text-end">
                                                            <span
                                        ...
                                        <div class="table-responsive mx-9 mt-n6">
                                            ...
                                            <table class="table align-middle gs-0 gy-4">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="#" class="text-gray-600 fw-bold fs-6">1:30
                                                                AM</a>
                                                        </td>
                                                        <td class="pe-0 text-end">
                                                            <span
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="d-flex flex-column my-7">
                                        <!--begin::Number-->
                                        <span
                                            class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $tableAv }}</span>
                                        <!--end::Number-->
                                        <!--begin::Follower-->
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-400">عدد الطاولات المتاحة</span>
                                        </div>
                                        <!--end::Follower-->
                                    </div>
                                    <!--end::Section-->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="d-flex flex-column my-7">
                                        <!--begin::Number-->
                                        <span
                                            class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $tableService }}</span>
                                        <!--end::Number-->
                                        <!--begin::Follower-->
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-400">عدد الطاولات في الخدمة</span>
                                        </div>
                                        <!--end::Follower-->
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="d-flex flex-column my-7">
                                        <!--begin::Number-->
                                        <span
                                            class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $reservationOnline }}</span>
                                        <!--end::Number-->
                                        <!--begin::Follower-->
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-400">اجمالي طلبات المتجر</span>
                                        </div>
                                        <!--end::Follower-->
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                                    ...
                                    <div class="d-flex flex-column my-7">
                                        <!--begin::Number-->
                                        <span
                                            class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $reservationOnlineToday }}</span>
                                        <!--end::Number-->
                                        <!--begin::Follower-->
                                        <div class="m-0">
                                            <span class="fw-semibold fs-6 text-gray-400"> إجمالي مبيعات اليوم</span>
                                        </div>
                                        <!--end::Follower-->
                                    </div>
                                </div>
