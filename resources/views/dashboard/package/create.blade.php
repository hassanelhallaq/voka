             ...
             <div class="card">
                 ...
                 <div class="card-body">
                     <div class="form-validation">
                         <form method="post" action="{{ route('packages.store') }}" class="needs-validation"
                             ...
                             <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="text" value="{{ old('name_en') }}" class="form-control mb-3"
                             ...
                             <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="number" class="form-control mb-3" id="count_of_visitors"
                                         value="{{ old('count_of_visitors') }}" name="count_of_visitors" required>
                             ...
                             <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="number" class="form-control mb-3" id="time"
                                         value="{{ old('time') }}" name="time" required>
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="number" class="form-control mb-3" id="discount"
                                         value="{{ old('discount') }}" name="discount" required>
