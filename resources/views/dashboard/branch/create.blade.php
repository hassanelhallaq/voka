                             ...
                             <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="text" class="form-control mb-3" name="name"
                                         id="validationCustom01" placeholder="{{ __('Branch Name') }}" required="">
                                     @if ($errors->has('name'))
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="text" class="form-control mb-3" name="name_en"
                                         id="validationCustom01" placeholder="{{ __('Branch Name En') }}"
                                         required="">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="text" class="form-control mb-3" name="phone"
                                         id="validationCustom01" placeholder="{{ __('phone') }}" required="">
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input type="text" class="form-control mb-3" name="manger"
                                         id="validationCustom01" placeholder="{{ __('Branch Manger') }}"
                                         required="">
