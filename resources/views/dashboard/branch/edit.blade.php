                            ...
                            @method('put')
                             ...
                             <div class="row">
                                 ...
                                 <div class="form-group col-md-6">
                                     <label>{{ __('Branch Name') }} <span class="text-danger">*</span>
                                     </label>
                                     <input type="text" class="form-control mb-3" name="name"
                                         value="{{ $branch->name }}" id="validationCustom01"
                                 ...
                                 <div class="form-group col-md-6">
                                     <label>{{ __('Branch Name En') }} <span class="text-danger">*</span>
                                     </label>
                                     <input type="text" class="form-control mb-3" name="name_en"
                                         value="{{ $branch->name_en }}" id="validationCustom01"
                                         placeholder="{{ __('Branch Name En') }}" required="">
                                     @if ($errors->has('name_en'))
                                         <p style="color: red">{{ $errors->first('name_en') }}</p>
                                     @endif
                                 </div>
                                 {{-- <div class="form-group col-md-6">
                                 ...
                                 <div class="form-group col-md-6">
                                     <label>{{ __('phone') }} <span class="text-danger">*</span>
                                     </label>
                                     <input type="text" class="form-control mb-3" name="phone"
                                         value="{{ $branch->phone }}" id="validationCustom01"
                                 ...
                                 <div class="form-group col-md-6">
                                     <label>{{ __('Branch Manger') }} <span class="text-danger">*</span>
                                     </label>
                                     <input type="text" class="form-control mb-3" name="manger"
                                         value="{{ $branch->manger }}" id="validationCustom01"
                                         placeholder="{{ __('Branch Manger') }}" required="">
                                     @if ($errors->has('manger'))
                                         <p style="color: red">{{ $errors->first('manger') }}</p>
                                     @endif
                                 </div>
                             </div>
