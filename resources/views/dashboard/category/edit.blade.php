         ...
         <div class="col-lg-12 col-md-12">
             <div class="body">
                 <form method="post" id='create_form'
                     action="{{ route('product-category.update', [$productCategory->category_id]) }}"
                     ...
                     <div class="image-section">
                         ...
                         <center>
                             ...
                             <div class="image-input image-input-outline" data-kt-image-input="true"
                                 style="background-image: url({{ $productCategory->getFirstMediaUrl('category_image', 'thumb') }})">
                         ...
                         <div class="form-group col-md-6">
                             ...
                             <div class="input-group mb-3">
                                 ...
                                 <input type="text" class="form-control"
                                     ...
                                     value="{{ $productCategory->category_name }}" aria-label="Username"
                                     aria-describedby="basic-addon1" @if (Session::has('category_name'))  @endif
                         ...
                         <div class="form-group col-md-6">
                             ...
                             <div class="input-group mb-3">
                                 ...
                                 <input type="text" class="form-control"
                                     ...
                                     value="{{ $productCategory->category_name_english }}"
                                     @if (Session::has('category_name_english'))  @endif
                                     @if (!$errors->isEmpty())  @endif>
                             </div>
                         ...
                         <div class="form-group col-md-6">
                             ...
                             <div class="input-group mb-3">
                                 ...
                                 <input type="number" class="form-control" placeholder="{{ __('Sort') }}"
                                     ...
                                     value="{{ $productCategory->category_order }}"
                                     @if (!$errors->isEmpty())  @endif
                             ...
                             <div class="input-group mb-3">
                                 ...
                                 <select class="form-select" data-control="select2" name="category_status"
                                     ...
                                     <option value="1"
                                         ...
                                         @if ($productCategory->category_status == '1') selected="selected" @endif>
                                         {{ __('Active') }}
                                     </option>
                                     <option value="0"
                                         @if (Session::get('category_status') == '0') selected="selected" @endif
                                         @if ($productCategory->category_status == '0') selected="selected" @endif>
                                         {{ __('Deactive') }}
                                     </option>
                                 </select>
                             </div>
