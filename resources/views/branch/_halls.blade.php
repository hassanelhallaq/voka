                            ...
                            <div class="row new-reservation-tables">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 card-col  d-flex justify-content-center align-items-center "  data-start="45" data-updatedTime="45">
                                      <div class="card bg-info text-dark {{ $item === 0 ? 'active-card' : '' }}" data-id="table{{$item->id}}" data-stat="serv">
                                        <div class="card-header primary-bg-color">
                                          <div class="top d-flex justify-content-between ">
                                            <h5 class="card-title">  Table {{ $tables->name }}</h5>
                                            <span class="start" >  </span>
                                          </div>
                                        </div>
                                        <div class="card-body">
                                          <div class="mid d-flex justify-content-between">
                                            <p class="hall-name">صالة 2</p>
                                            <span class="sta">فى الخدمة</span>
                                          </div>
