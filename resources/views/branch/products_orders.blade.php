                                        ...
                                        <div class="card" style="width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <footer>
                                                    ...
                                                    <span id="number_{{ $product->product_id }}"
                                                        class="number mx-3">0</span>
                    ...
                    <div class="tab-content">
                        <div id="tab1" class="tab-pane fade show active">
                            <ol class="table-list list-group list-group-numbered reversed">
                                <li
                                    class="menu-info-list list-group-item d-flex justify-content-center align-items-center text-center">
                                    <p>لا يوجد عناصر</p>
                                </li>
...
@section('js')
    ...
    <script>
        ...
        function storeProduct(id) {
            ...
            storepart('/branch/order-product/store', formData);
