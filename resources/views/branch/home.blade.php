                                                    ...
                                                    <div class="table-btn my-3 text-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <button class="table-btn-action btn btn-primary w-100"
                                                                        type="button"  @if (!$table->reservation)  disabled
                                                                        @endif data-id="#exampleModal_{{ $table->id }}">
                                                                        تفعيل الحجز
                                                                    </button>
                                                                </div>
                                                    ...
                                                    <div class="table-btn my-3 text-center">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <button class="table-btn-action btn btn-primary w-100"
                                                                        type="button"   @if (!$table->reservation) disabled @endif data-id="#exampleModal_{{ $table->id }}">
                                                                        تفعيل الحجز
                                                                    </button>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <button class="table-btn-action btn btn-primary w-100"
                                                                        type="button" @if (!$table->reservation) disabled @endif data-id="#tableend">
                                                                        انهاء الحجز
                                                                    </button>
                                                                      <!-- Modal -->
                                                                            <div class="modal fade"
