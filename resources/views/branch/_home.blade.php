                          ...
                          <div class="btn-group d-flex flex-column" role="group" aria-label="Basic example">
                              @foreach ($halles as $key => $item)
                                  <button type="button" class="h-filter btn btn-dark"
                                      data-salon="hall{{ $item->id }}">{{ $item->name }}</button>
                              @endforeach
                          </div>
                          <div class="btn-group d-flex flex-column my-3" role="group" aria-label="Basic example">
                                                            ...
                                                            <div class="card-footer">
                                                                    <div class="table-btn my-3 text-center">
                                                                        <div class="row">
                                                                            ...
                                                                            <div
                                                                                class="col-md-6 active-the-reversation">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                @if ($table->reservation)
                                                                                    <button type="button"
                                                                                        class="btn btn-primary w-100"
                                                                                        data-bs-toggle="modal"
                                                                                        data-bs-target="#close_{{ $table->id }}">
                                                                                        انهاء الحجز
                                                                                    </button>
                                                                                @else
                                                                                    <button type="button" disabled
        ...
        $('.s-filter').on('click', function() {
         ...
         $('.h-filter').on('click', function() {
            ...
            if (key === 'all') {
                ...
                $('.sofa').addClass('not-selected'); // إخفاء جميع العناصر
                // إظهار العناصر التي تحمل قيمة مطابقة لـ data-pstat
                $('.sofa[data-h="' + key + '"]').removeClass('not-selected');
            }
        });
    });
</script>
